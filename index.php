    ...
    <style>
        ...
        * {
        ...
        .kpi-card {
            ...
            align-items: center;
            justify-content: center;
            box-shadow: 12px 12px 30px #bebebe, -12px -12px 30px #ffffff;
            transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);
            min-height: 95px;
        }
        ...
        <?php if ($page == 'dashboard' && isTeacher()): ?>
            ...
            <div class="content-wrapper">
                ...
                <div class="reports-main-content">
                    ...
                    <!-- Main Content Grid -->
                    <div class="responsive-grid-2" style="margin-top: 30px;">
                        ...
                        <div class="chart-card">
                            ...
                            <form id="taskForm" style="padding: 20px;">
                                ...
                                <div class="responsive-form-grid" style="margin-bottom: 15px;">
                                    <div>
